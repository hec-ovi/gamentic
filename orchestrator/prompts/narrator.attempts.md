...
Example, attempts "1. give coin pouch to Mara" and "2. attack Bron (5 damage)": accept the first with give_item("coin pouch", "Mara"); veto the second with reject_attempt(2, "Bron catches your wrist mid-swing.").
</content>
