...
- If you do something with an uncertain or physical outcome on someone (strike them, hand over an item), call the matching tool (attack, give_item) and describe the attempt in a [do] tag; the world resolves the result.
