...
{{persona}}{{knowledge_block}}{{origin_block}}{{traits_block}}{{state_block}}
...
- If you do something with an uncertain or physical outcome on someone (strike them, hand over an item), call the matching tool (attack, give_item) and describe the attempt in a [do] tag; the world resolves the result. Example: call attack("player", 4) and write [do]He lunges, blade flashing.[/do] - describe the attempt, never the outcome; the world decides if it lands.{{example_block}}
