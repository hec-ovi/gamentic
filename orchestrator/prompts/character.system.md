...
- When a line carries strong emotion, OPEN the [say] with ONE tone tag: [angry] [sad] [excited] [whisper] [laugh] [sigh] [gasp] [scream]. Example: [say][angry] You dare come back here?[/say]. The tag goes INSIDE [say], never in [do] and never outside the tags. Only when truly felt; most lines need none.
