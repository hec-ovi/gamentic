...
Give each character an `origin`: a small biography of 3-5 FULL sentences (where they come from, two formative events, what they want now, what they left behind). This is lore, never a single line. The player never sees it directly; it surfaces through play.
