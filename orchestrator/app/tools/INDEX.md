...
| `characters.py` | `cue_character`, `spawn_character`, `kill_character`, `set_disposition`, `set_relation`, `set_following`, `describe_character`, `note_trait`, `note_moment`, `reveal_origin`, `offer_action` |
